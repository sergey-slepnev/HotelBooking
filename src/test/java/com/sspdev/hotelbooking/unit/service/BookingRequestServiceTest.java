    ...
    void findById_shouldFindRequestById_ifRequestExists() {
        ...
        expectedRequest.ifPresent(request -> {
            assertAll(() -> {
                        ...
                        assertThat(request.hotelId()).isEqualTo(existentRequest.getHotel().getId());
                        assertThat(request.roomId()).isEqualTo(existentRequest.getRoom().getId());
                        assertThat(request.userId()).isEqualTo(existentRequest.getUser().getId());
